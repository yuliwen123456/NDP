# V09 proposal: Class-Conditional ID Tail Calibration; replaces overlapping CGAC

Version v09; parent V06; date 2026-09-14; branch feature/v09-class-conditional.
Git commit: resolve the immutable proposal tag `proposal-v09` with `git rev-parse proposal-v09`; actual SHA is appended to main VERSION_HISTORY.md after commit.
Conclusion: NEEDS_MORE_TESTING. No algorithm implementation, training or evaluation has run.

Read main analysis/research_audit_v01.md for the full hypothesis, formula, duplication analysis, risks and acceptance protocol. Module planned only: experiments/v09_class_conditional/modules/class_conditional_v09.py.

All files here are NEW: README.md, config_v09_class_conditional.json, metrics.json, train_command.sh, eval_command.sh, manifest_v09.json. Future implementation needs additional versioned files outside this frozen proposal directory (for example experiments/v09_class_conditional_implementation01/); do not overwrite this proposal to implement it. This preserves the proposal and later implementation independently.
